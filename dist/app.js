...
System.register("github:angular/bower-angular-aria@1.3.14/angular-aria", ["github:angular/bower-angular@1.3.14"], false, function(__require, __exports, __module) {
  System.get("@@global-helpers").prepareGlobal(__module.id, ["github:angular/bower-angular@1.3.14"]);
  (function() {
    "format global";
    "deps angular";
...
System.register("lib/angular-locale_pl-pl", [], false, function(__require, __exports, __module) {
  System.get("@@global-helpers").prepareGlobal(__module.id, []);
  (function() {
    'use strict';
...
System.register("client/Food", [], function (_export) {
  var _createClass, _classCallCheck, Food;
  ...
  return {
    ...
    execute: function () {
      ...
      Food = (function () {
        function Food(confObj) {
          var _this = this;

          _classCallCheck(this, Food);

          ["_id", "name", "kcal", "proteins", "carbs", "fat"].forEach(function (prop) {
            return _this[prop] = confObj[prop];
          });
          if (confObj.unit) {
            ["unit", "unitWeight"].forEach(function (prop) {
              return _this[prop] = confObj[prop];
            });
            this._units = 1;
            this.calcWeight();
        ...
        _createClass(Food, {
          add: {
            value: function add(prop, delta) {
              var ease = arguments[2] === undefined ? false : arguments[2];
          ...
          calcWeight: {
            value: function calcWeight() {
              this._weight = this.unitWeight * this._units;
              this.calcNutrition();
            }
          },
          calcUnits: {
            value: function calcUnits() {
              this._units = this._weight / this.unitWeight;
              this.calcNutrition();
            }
          },
          calcNutrition: {
            value: function calcNutrition() {
              var _this = this;

              ["kcal", "proteins", "carbs", "fat"].forEach(function (val) {
                _this["_weight_" + val] = _this[val] * _this._weight / 100;
              });
            }
          },
          calcKcal: {
            value: function calcKcal() {
      ...
      _export("default", Food);
    }
  };
});
System.register("client/Requirements", [], function (_export) {
  var _createClass, _classCallCheck, Requirements;
    ...
    execute: function () {
      ...
      Requirements = (function () {
        function Requirements() {
          var weight = arguments[0] === undefined ? 0 : arguments[0];
          var bodyFat = arguments[1] === undefined ? 0 : arguments[1];
        ...
        _createClass(Requirements, {
          ...
          kcalForLBM: {
            value: function kcalForLBM() {
              if (this.bodyFat >= 22.1) {
                return 13;
              }if (this.bodyFat >= 19.1) {
                return 14;
              }if (this.bodyFat >= 15.1) {
                return 15;
              }if (this.bodyFat >= 12.1) {
                return 16;
              }return 17;
            }
          }
      ...
      _export("default", Requirements);
    }
  };
});
System.register("client/services", [], function (_export) {
  return {
    setters: [],
    execute: function () {
      "use strict";
      ...
      _export("default", angular.module("foodDiaryApp-services", []).factory("focus", function ($timeout) {
        return function (el) {
...
System.register("client/filters", [], function (_export) {
  return {
    setters: [],
    execute: function () {
      "use strict";

      _export("default", angular.module("foodDiaryApp-filters", []).filter("round", function () {
...
System.register("github:angular/bower-angular-aria@1.3.14", ["github:angular/bower-angular-aria@1.3.14/angular-aria"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = require("github:angular/bower-angular-aria@1.3.14/angular-aria");
  global.define = __define;
  return module.exports;
});
...
System.register("client/main.controller", ["client/Food", "client/Requirements"], function (_export) {
    var Food, Requirements;
    ...
    return {
        setters: [function (_clientFood) {
            Food = _clientFood["default"];
        }, function (_clientRequirements) {
            Requirements = _clientRequirements["default"];
        }],
        execute: function () {
            "use strict";
        }
...
System.register("client/menu/menu.controller", ["client/Food", "client/Requirements", "client/services"], function (_export) {
    var Food, Requirements;

    _export("default", MenuCtrl);

    function MenuCtrl($scope, $http, focus, dateFilter) {
        $scope.searchFood = {};
        $scope.date = new Date();
        $scope.eaten = [];
        ...
        $scope.updateSums = function () {
            ...
            for (var i = 0; i < $scope.eaten.length; i++) {
                ...
                ["kcal", "proteins", "carbs", "fat"].forEach(function (type) {
        ...
        $scope.addEaten = function (food) {
            $scope.eaten.push(new Food(food));
            $scope.searchFood = $scope.searchText = null;
            $scope.saveEaten();
        };

        $scope.deleteEaten = function (index) {
            $scope.eaten.splice(index, 1);
            $scope.saveEaten();
        };

        $scope.$watch("searchFood.food", function (searchFood) {
            if (searchFood) {
        ...
        $scope.saveEaten = function () {
            var data = {
                ...
                foodList: $scope.eaten.map(function (food) {
                    return {
                        food: food._id,
            ...
            $http.post("/api/eaten", data).then(function (res) {
        ...
        $http.get("/api/eaten/" + dateFilter($scope.date, "dd.MM.yyyy")).success(function (data) {
            $scope.eaten = data.foodList.map(function (foodObj) {
    ...
    return {
        setters: [function (_clientFood) {
            ...
            Requirements = _clientRequirements["default"];
        }, function (_clientServices) {}],
        execute: function () {
            "use strict";
        }
    };
});
System.register("github:angular/bower-material@0.8.3/angular-material", ["github:angular/bower-material@0.8.3/angular-material.css!github:systemjs/plugin-css@0.1.6", "github:angular/bower-angular@1.3.14", "github:angular/bower-angular-animate@1.3.14", "github:angular/bower-angular-aria@1.3.14"], false, function(__require, __exports, __module) {
  System.get("@@global-helpers").prepareGlobal(__module.id, ["github:angular/bower-material@0.8.3/angular-material.css!github:systemjs/plugin-css@0.1.6", "github:angular/bower-angular@1.3.14", "github:angular/bower-angular-animate@1.3.14", "github:angular/bower-angular-aria@1.3.14"]);
  (function() {
    "format global";
...
System.register("client/main", ["github:angular/bower-angular@1.3.14", "github:angular/bower-material@0.8.3", "lib/angular-locale_pl-pl", "npm:font-awesome@4.3.0/css/font-awesome.min.css!github:systemjs/plugin-css@0.1.6", "client/main.controller", "client/menu/menu.controller", "client/services", "client/filters"], function (_export) {
    var angular, MainCtrl, MenuCtrl, services, filters;
    return {
        setters: [function (_githubAngularBowerAngular1314) {
            angular = _githubAngularBowerAngular1314["default"];
        }, function (_githubAngularBowerMaterial083) {}, function (_libAngularLocale_plPl) {}, function (_npmFontAwesome430CssFontAwesomeMinCssGithubSystemjsPluginCss016) {}, function (_clientMainController) {
            MainCtrl = _clientMainController["default"];
        }, function (_clientMenuMenuController) {
            MenuCtrl = _clientMenuMenuController["default"];
        }, function (_clientServices) {
            services = _clientServices["default"];
        }, function (_clientFilters) {
            filters = _clientFilters["default"];
        }],
        execute: function () {
            "use strict";
            ...
            angular.module("foodDiaryApp", ["ngMaterial", services.name, filters.name]).controller(MainCtrl.name, MainCtrl).controller(MenuCtrl.name, MenuCtrl);
...
System.register('github:angular/bower-material@0.8.3/angular-material.css!github:systemjs/plugin-css@0.1.6', [], false, function() {});
System.register('npm:font-awesome@4.3.0/css/font-awesome.min.css!github:systemjs/plugin-css@0.1.6', [], false, function() {});
(function() {
  var loader = System;
